...
//	int x = 0;
//	while (x<36){
//		System.out.println(Cipher.keyedEncode("u4y i1e i5 i6ita5c 314c1i66e1 i5f by6i5 hea5c zbi58 u4y", x));
//		x++;
//	}
	
//	int y = 0;
//	while (y<36){
//		System.out.println(Cipher.keyedEncode("amlb mfhp7fcj jlgq fo tap s9a bjlslql aflipa lb hlg9b 210z t9ct", y));
//		y++;
//	}
	...
	System.out.print("Here is your encoded message:");
